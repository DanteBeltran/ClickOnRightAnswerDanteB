...
local function RestartScene()
    ...
    -- if they have 0 lives, go to the You Win screen
...
function scene:create( event )
    ...
    addEquationTextObject = display.newText( "", display.contentWidth*1/4, display.contentHeight*3/5, nil, 50 )
    ...
    answerTextObject = display.newText("", display.contentWidth*.4, display.contentHeight/4*3, nil, 50 )
    wrongAnswer1TextObject = display.newText("", display.contentWidth*.3, display.contentHeight/4*3, nil, 50 )
    wrongAnswer2TextObject = display.newText("", display.contentWidth*.2, display.contentHeight/4*3, nil, 50 )
    wrongAnswer3TextObject = display.newText("", display.contentWidth*.1, display.contentHeight/4*3, nil, 50 )
